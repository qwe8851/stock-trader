...
# Ensure the backend package root is on the path so imports work
...
from db.models import ohlcv, user  # noqa: F401
...
def run_migrations_offline() -> None:
    ...
    Generates SQL statements to stdout without a live DB connection.
    """
